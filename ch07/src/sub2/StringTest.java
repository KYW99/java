...
public class StringTest {
	public static void main(String[] args) {
		...
		// 문자열(문자+배열) 생성
		String str1 = "Hello";  //String = 끈, 로프 why not word? H e l l o 하나하나 배열구조 /리터럴 문자열
		...
		//문자열 비교 --> 무조건 equals
		if(str1 == str2) {
			System.out.println("str1,str2가 주소값 같다.");
		}else {
			System.out.println("str1,str2가 주소값 다르다.");
		}
		
		if(str1.equals(str2)) {
			System.out.println("str1,str2가 문자열 같다.");
		}else {
			System.out.println("str1,str2가 문자열 다르다.");
		}
		...
		int idx2 = message.lastIndexOf("e");  //뒤에서부터
